    ...
    public partial class AdminAdd : Form
    {
        ...
        private void btnAdminAdd_Click(object sender, EventArgs e)
        {
            if (NameField.Text != "Full Name" && (Male.Checked) || (Female.Checked) && CNICField.Text != "CNIC" && txtConfirmPassword.Text != "Date of Birth" && phoneField.Text != "Phone" && AgeField.Text != "Age" && EduField.Text != "Qualification" && txtUsername.Text != "UserName" && txtPassword.Text != "Password" && txtConfirmPassword.Text != "Confirm Password")
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("insert into Admin(Admin_Username,Admin_Password,Admin_Name,Admin_Gender,Admin_CNIC,Admin_DOB,Admin_Contact,Admin_Age,Admin_Qualification,Admin_Address) values(@AdminUsername,@AdminPassword,@AdminName,@AdminGender,@AdminCNIC,@AdminDOB,@AdminPhone,@AdminAge,@AdminQualification,@AdminAddress)", con);
                    cmd.CommandType = CommandType.Text;

                    cmd.Parameters.AddWithValue("@AdminUsername", txtUsername.Text);
                    cmd.Parameters.AddWithValue("@AdminPassword", txtConfirmPassword.Text);
        ...
        private void txtUsername_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Select * from Admin where Admin_username = '" + txtUsername.Text + "'", con);
