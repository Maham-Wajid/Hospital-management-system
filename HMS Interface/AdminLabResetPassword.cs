...
{
    public partial class AdminLabResetPassword : Form
    {
        public AdminLabResetPassword()
        {
            InitializeComponent();
        }
        ...
        private void txtUsername_TextChanged(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Laboratorist where Laboratorist_username = @username", con);
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Update Laboratorist SET Laboratorist_password = @password where Laboratorist_username = @username", con);
                cmd.CommandType = CommandType.Text;
