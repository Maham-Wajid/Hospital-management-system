...
{
    public partial class AdminNrsResetPassword : Form
    {
        public AdminNrsResetPassword()
        {
            InitializeComponent();
        }
        ...
        private void txtUsername_TextChanged(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Nurses where Nurse_username = @username", con);
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Update Nurses SET Nurse_password = @password where Nurse_username = @username", con);
                cmd.CommandType = CommandType.Text;
