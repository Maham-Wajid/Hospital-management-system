...
{
    public partial class AdminPhrmcyAdd : Form
    {
        public AdminPhrmcyAdd()
        {
            InitializeComponent();
        ...
        private void btnPhrmAdd_Click(object sender, EventArgs e)
        {
            if (NameField.Text != "Full Name" && (Male.Checked) || (Female.Checked) && CNICField.Text != "CNIC" && phoneField.Text != "Phone" && AgeField.Text != "Age" && EduField.Text != "Qualification")
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("insert into Pharmacist(Pharmacist_username,Pharmacist_password,Pharmacist_name,Pharmacist_gender,Pharmacist_CNIC,Pharmacist_DOB,Pharmacist_contact,Pharmacist_age,Pharmacist_qualification,Pharmacist_address) values(@PhrmUsername,@PhrmPassword,@PhrmName,@PhrmGender,@PhrmCNIC,@PhrmDOB,@PhrmPhone,@PhrmAge,@PhrmQualification,@PhrmAddress)", con);
                    cmd.CommandType = CommandType.Text;

                    cmd.Parameters.AddWithValue("@PhrmUsername", txtUsername.Text);
                    cmd.Parameters.AddWithValue("@PhrmPassword", txtPassword.Text);
        ...
        {
            AdminPhrmcyAdd Add = new AdminPhrmcyAdd();
            Add.Show();
            this.Close();
        }
    }
