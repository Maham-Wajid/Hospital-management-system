...
{
    public partial class AdminRcptResetPassword : Form
    {
        public AdminRcptResetPassword()
        {
            InitializeComponent();
        }
        ...
        private void txtUsername_TextChanged(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Receptionist where Receptionist_username = @username", con);
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Update Receptionist SET Receptionist_password = @password where Receptionist_username = @username", con);
                cmd.CommandType = CommandType.Text;
