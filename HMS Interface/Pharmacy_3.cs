...
{
    public partial class Pharmacy_3 : Form
    {
        public Pharmacy_3()
        {
            InitializeComponent();
        ...
        private void Pharmacy_3_Load(object sender, EventArgs e)
        {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Quantity Added Successfully!", "Add Quantity", MessageBoxButtons.OK, MessageBoxIcon.Information);
                con0.Close();
                con.Close();
            }
        }
